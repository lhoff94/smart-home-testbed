...
def main():
    ...
    zigbee2mqtt = DockerNode('zigbee2mqtt', docker_image='koenkk/zigbee2mqtt:latest-dev', volumes={zigbee_data_directory:{'bind':'/app/data','mode':'rw'},'/run/udev':{'bind':'/run/udev','mode':'ro'}} , devices="/dev/ttyUSB0:/dev/ttyUSB0", exposed_ports={'8080':'8080'})
